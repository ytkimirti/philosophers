...
/*   Updated: 2022/08/17 18:33:27 by ykimirti         ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	check_values(t_vars *vars)
{
	if (vars->count > SEM_VALUE_MAX)
		return (exit_program("You can have at most SEM_VALUE_MAX forks!"));
	if (vars->count < 2
